...
@interface CreditCardInstructionsViewController ()
...
@implementation CreditCardInstructionsViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row==1) {
        ...
        [captureBtn setImage:[UIImage imageNamed:@"credit card.png"] forState:UIControlStateNormal];
